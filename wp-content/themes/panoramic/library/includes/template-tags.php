...
function panoramic_post_nav() {
	...
	<nav class="navigation post-navigation" role="navigation">
		...
		<div class="nav-links">
			...
			previous_post_link( '<div class="nav-previous">%link</div>', _x( '%title&nbsp;<span class="meta-nav">&rarr;</span>', 'Previous post link', 'panoramic' ), false, $slider_categories);
			next_post_link(     '<div class="nav-next">%link</div>',     _x( '<span class="meta-nav">&larr;</span>&nbsp;%title', 'Next post link',     'panoramic' ), false, $slider_categories);
			?>
		</div><!-- .nav-links -->
	</nav><!-- .navigation -->
	<?php
